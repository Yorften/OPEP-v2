...
<body>
    <div class="flex flex-col justify-end items-start h-[100vh]">
        ...
        <table class="table-fixed w-full ">
            ...
            ';
                        if ($status == 1) {
                            echo '<td class="px-4 py-2 border-2 border-[#A3A3A3] text-xs md:text-base text-center">
                <a href="changestatus.php?id=' . $id . '&status=' . $status . '" class="px-2 rounded-md bg-green-600"> Active </a>
                </td>';
                        } else {
                            echo '<td class="px-4 py-2 border-2 border-[#A3A3A3] text-xs md:text-base text-center">
                <a href="changestatus.php?id=' . $id . '&status=' . $status . '" class="px-2 rounded-md bg-red-600"> Disabled </a>
                </td>';
                        }
                        echo '</tr>';
                    }
