...
<body>
    ...
    <div class="overflow-y-hidden h-12">
                ...
                <div class="flex items-center">
                    <div class="dropdown">
                        ...
                        <div class="flex items-center justify-center gap-6">
                            ...
                            <?php } else { ?>
                            <p id="basket-count"
                                class="bg-amber-400 rounded-3xl w-5 h-5 text-center absolute top-2 right-[55px] sm:block sm:right-[55px] md:right-[17px] md:block">
                                <?php echo $count ?>
                            </p>
                            <img onclick="openPopup()"
                                class="open-btn dropbtn color-black cursor-pointer w-9  h-9 object-contain sm:block sm:mr-1  "
                                src="src/images/cart.png" alt="" />
                            <?php } ?>
                        </div>
                    </div>
                    <div id="burgermenu" onclick="toggleBurgerMenu()"
                        class="md:hidden md:mx-2 cursor-pointer mr-3 ml-3">
            ...
            <div class="flex flex-col gap-1">
                ...
                <div class="p-3 mt-6">
                    ...
                    <div class="flex flex-col relative border-2 border-gray-400 w-full h-[140px] rounded-md mb-2">
                        <div
                            class="flex items-center justify-end w-full bg-[#19911D] h-4 rounded-tl-[4px] rounded-tr-[4px]">
                        </div>
                        <div class="flex gap-2 flex-col items-center justify-between md:flex-row">
                            <img class="object-contain h-[124px]" src="src/images/Plants/<?php echo $plantImage ?>"
                                alt="">
                            ...
                            <div class="flex flex-col justify-end h-full gap-2 pr-2 pb-2">
                                <a href="src/pages/deleteitem.php?plantId=<?php echo $plantId ?>"
                                    class="p-1 bg-red-500 border border-black rounded-lg">Remove</a>
                            </div>
                        </div>
                    </div>
                    <?php
                ...
                <div class="fixed w-[30%] h-14 bottom-0 p-1 bg-white">
                    <div class="flex justify-evenly">
                        <?php if ($count > 0) { ?>
                        <a class="border border-black bg-[#19911D] font-semibold p-1 hover:bg-[#5edb64] rounded-md"
                            href="src/pages/checkout.php">Checkout</a>
                        <a class="border border-black bg-[#19911D] font-semibold p-1 hover:bg-[#5edb64] rounded-md"
                            href="src/pages/emptycart.php">Empty cart</a>
                        <?php } else { ?>
        ...
        <div id="displaymenu"
            class="flex flex-col border-2 border-t-0 border-amber-600 items-center justify-center burger-content w-full py-6 hidden md:hidden">
            <div class="flex flex-col items-center divide-y-2 gap-6 w-full divide-amber-600">
                <?php if (!isset($_SESSION['client_name']) && !isset($_SESSION['admin_name']) && !isset($_SESSION['administrator_name'])) : ?>
                <div class="child:text-black child:text-lg">
                    <a href="src/pages/login.php" class="border-r border-black pr-1"> Log in</a>
                    <a href="src/pages/signup.php"> Sign up</a>
                </div>
                <?php else : ?>
                <?php if (isset($_SESSION['client_name'])) : ?>
    ...
    <main class="h-[53.9vh] bg-[url('/OPEP-v2/src/images/hero.webp')] bg-cover bg-no-repeat">
        <div class="flex flex-col items-start justify-center h-full w-[40%] ml-[10%] gap-4">
            <h1 class="text-[42px] text-white font-medium stroke-2 stroke-black">Your online shop for houseplants and
                more!</h1>
            <a href="src/pages/catalog.php"
                class="text-md font-medium p-2 w-42 bg-amber-300 border-2 border-amber-400 rounded-2xl">Shop all
                plants</a>
        </div>
    </main>
    <div class="bg-[#bdff72] ">
        <div
            class="flex flex-col gap-10 text-center md:gap-0 md:flex md:flex-row md:items-center md:justify-around md:pt-12">
        ...
        <div class="  md:text-center md:text-black md:pt-16  ">
            <p>© 2023 O'PEP. All Rights Reserved.</p>
        </div>
        <div class="text-center text-black pt-10   md:hidden  ">
